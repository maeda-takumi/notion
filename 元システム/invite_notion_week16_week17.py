...
SHEET_NAME = "week17"
NEXT_SHEET_NAME = "weekend"

# Notion 招待対象ページ
NOTION_PAGE_URL = "https://www.notion.so/AI-Week-note-2af8252adfa780f48ac9d179962f75ce"
...
def write_to_next_sheet(sheet_next, email):
    ...
    print(f" → Week15 シートに登録：{email}, {future_date.strftime('%Y/%m/%d')}")
